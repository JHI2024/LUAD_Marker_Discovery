...
raw_patientdata_of_nte<-subset(clinical_patient,clinical_patient$bcr_patient_barcode%in%unique(followupdata_of_nte$bcr_patient_barcode)==TRUE)

raw_patientdata_of_not_nte<-subset(clinical_patient,clinical_patient$bcr_patient_barcode%in%unique(followupdata_of_clinical_not_nte$bcr_patient_barcode)==TRUE)


#Condition1: Residual tumor=R0이고 neoadjuvant treatmenT=NO에 해당되는 두 환자 집단  
con1_patientdata_of_nte<-subset(clinical_patient,clinical_patient$bcr_patient_barcode%in%unique(followupdata_of_nte$bcr_patient_barcode)==TRUE 
                           & clinical_patient$history_neoadjuvant_treatment=='No'
                           & clinical_patient$residual_tumor=='R0'
)
con1_patientdata_of_not_nte<-subset(clinical_patient,clinical_patient$bcr_patient_barcode%in%unique(followupdata_of_clinical_not_nte$bcr_patient_barcode)==TRUE
                               & clinical_patient$history_neoadjuvant_treatment=='No'
                               & clinical_patient$residual_tumor=='R0'
)
...
con2_patientdata_of_nte<-subset(clinical_patient,clinical_patient$bcr_patient_barcode%in%unique(followupdata_of_nte$bcr_patient_barcode)==TRUE 
                                & clinical_patient$history_neoadjuvant_treatment=='No'
                                & clinical_patient$residual_tumor=='R0'
                                & (clinical_patient$ajcc_pathologic_tumor_stage=='Stage IA'|clinical_patient$ajcc_pathologic_tumor_stage=='Stage IB')
)
con2_patientdata_of_not_nte<-subset(clinical_patient,clinical_patient$bcr_patient_barcode%in%unique(followupdata_of_clinical_not_nte$bcr_patient_barcode)==TRUE
                                    & clinical_patient$history_neoadjuvant_treatment=='No'
                                    & clinical_patient$residual_tumor=='R0'
                                    & (clinical_patient$ajcc_pathologic_tumor_stage=='Stage IA'|clinical_patient$ajcc_pathologic_tumor_stage=='Stage IB')
)
...
table(con1_patientdata_of_nte$ajcc_pathologic_tumor_stage)
pie(table(raw_patientdata_of_not_nte$ajcc_pathologic_tumor_stage))
pie(table(raw_patientdata_of_nte$ajcc_pathologic_tumor_stage))
